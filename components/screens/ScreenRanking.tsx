  ...
  return (
    <div className="flex flex-col gap-1.5 py-2">
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="text-white font-mono font-black text-3xl shrink-0">{formatMillions(b.hoyNeto)}</span>
      </div>
    ...
    <div className="w-screen h-screen bg-[#0b0e14] text-white flex flex-col p-8 overflow-hidden">
      <div className="mb-6 shrink-0 flex items-end justify-between border-b border-white/5 pb-4">
        ...
        <div className="text-right">
          <p className="text-gray-400 text-sm font-bold tracking-widest uppercase">Total Red Hoy</p>
          <p className="text-white font-mono font-black text-4xl">{formatMillions(data.totalNeto)}</p>
        </div>
      </div>
